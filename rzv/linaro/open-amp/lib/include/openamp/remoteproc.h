...
struct remoteproc_ops
{
    struct remoteproc * (* init)(struct remoteproc * rproc, struct remoteproc_ops * ops, void * arg);
    void                (* remove)(struct remoteproc * rproc);
    void              * (* mmap)(struct remoteproc * rproc, metal_phys_addr_t * pa, metal_phys_addr_t * da, size_t size,
 ...
 * @io - pointer to the I/O region
 */
static inline void remoteproc_init_mem (struct remoteproc_mem  * mem,
                                        const char             * name,
                                        metal_phys_addr_t        pa,
                                        metal_phys_addr_t        da,
                                        size_t                   size,
 ...
 * @mem - pointer to remoteproc memory
 */
static inline void remoteproc_add_mem (struct remoteproc * rproc, struct remoteproc_mem * mem)
{
    if (!rproc || !mem)
    {
        return;
